...
import com.example.twt.mobileplayer.view.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    private void setListener() {
        ...
        mVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                tvDuration.setText(mUtils.stringForTime((int) mp.getDuration()));
                seekbarVideo.setMax((int) mp.getDuration());
                setButtonState();
                //把加载页面消失掉
    ...
    private void ShowConfigDialog() {
        final AlertDialog.Builder builder=new AlertDialog.Builder(VitamioVideoPlayer.this);
        builder.setTitle("提示");
        builder.setMessage("你可以切换到标准播放器进行观看");
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                StartToMediaPlayer();
